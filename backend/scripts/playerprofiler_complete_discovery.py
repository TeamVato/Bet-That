    ...
    def analyze_csv(self, file_path):
        ...
        try:
            ...
            csv_info["analysis"] = {
                ...
                "player_columns": [
                    col for col in df.columns if "player" in col.lower() or "name" in col.lower()
                ],
        ...
        try:
            with open(file_path, "r", encoding="utf-8", errors="ignore") as f:
                ...
                if any(
                    ...
                    for term in ["column", "field", "definition", "glossary"]
                ):
    ...
    def categorize_columns(self, columns):
        ...
        for col in columns:
            ...
            # Defense stats
                ...
                x in col_lower for x in ["def", "allow", "against", "opp_", "dvoa", "pressure"]
            ):
    ...
    def generate_comprehensive_report(self):
        ...
        report = {
            ...
            "summary": {
                ...
                "data_files": sum(
                    1
                    for f in self.inventory["folders"].values()
                    for file in f["files"]
                    if file.get("category") == "DATA"
                ),
                "documentation_files": sum(
                    1
                    for f in self.inventory["folders"].values()
                    for file in f["files"]
                    if file.get("category") == "DOCUMENTATION"
                ),
            },
            "key_discoveries": {},
            "strategy_support": {},
...
def main():
    ...
    output_file = Path(
        "/Users/vato/work/Bet-That/backend/data/playerprofiler_complete_inventory.json"
    )
    ...
    save_data = {
        ...
        "folder_summary": {
            k: {"file_count": v["file_count"], "subfolders": v["subfolders"]}
